  ...
  return (
    <section className="w-full max-w-4xl mx-auto mb-20 px-6">
      <div className="flex flex-col items-center justify-center p-12 md:p-16 rounded-[60px] bg-white/[0.01] border border-white/5 backdrop-blur-3xl relative overflow-hidden group shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-indigo-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
        
        <div className="relative z-10 flex flex-col items-center">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border border-white/10 flex items-center justify-center mb-8 bg-black/40 shadow-inner group-hover:scale-110 group-hover:border-cyan-500/40 transition-all duration-700">
                <svg className="w-10 h-10 sm:w-12 sm:h-12 text-white/40 group-hover:text-cyan-400 group-hover:drop-shadow-[0_0_15px_#22d3ee] transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-12 mt-4">
              {[
                { label: 'Americas', val: regional.americas, color: 'text-cyan-400' },
